      ...
      <div className={styles.main}>
        <div className={styles.MainContainer}>
          ...
          <div className={styles.Cards}>
            ...
            <Link href={`/${locale}/services/hospitality`} className={styles.Card}>
            ...
            <Link href={`/${locale}/services/residential`} className={styles.Card}>
              <div className={styles.CardTop}>
            ...
            <Link href={`/${locale}/services/commercial`} className={styles.Card}>
              <div className={styles.CardTop}>
