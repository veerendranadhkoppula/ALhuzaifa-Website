...
const RelatedProjects = ({ projects, locale, serviceSlug, heading }) => {
        ...
        <div className={styles.desktopSection}>
          ...
          <div className={styles.desktopGrid}>
            {projects.map((project) => (
              <Link
                key={project.id}
                href={`/${locale}/services/${serviceSlug}/${project.slug}`}
        ...
        <div className={styles.mobileSection}>
          ...
          {useCarousel ? (
            ...
            <div className={styles.singleCard}>
              <Link
                href={`/${locale}/services/${serviceSlug}/${projects[0].slug}`}
                className={styles.card}
              >
                ...
                <div className={styles.cardBottom}>
                  <span className={styles.title}>{projects[0].title}</span>
                  <ArrowRight />
                </div>
              </Link>
            </div>
