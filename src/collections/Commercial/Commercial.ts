  ...
  fields: [
    {
      ...
      localized: true,
      admin: {
        description: 'Project title e.g. Burj Al Arab Office',
      },
    },
    {
      name: 'slug',
          ...
          fields: [
            {
              ...
              required: true,
              admin: {
                description: 'Image shown on the Commercial services listing grid',
              },
            },
          ],
        },
          ...
          fields: [
            {
              ...
              type: 'relationship',
              relationTo: 'commercial' as 'commercial',
              hasMany: true,
              maxRows: 3,
              admin: {
                description: 'Select up to 3 related commercial projects',
              },
            },
          ],
        },
